...
export const PLUGIN_CONSTANTS = {
	VIEW_TYPE: 'svn-file-history',
	ICON_ID: 'svn-logo',
	PLUGIN_NAME: 'Obsidian SVN',
...
export const DEFAULT_SETTINGS = {
	...
	pinCheckedOutRevision: false
};

export const SVN_ICON_SVG = `
<svg role="img" viewBox="0 -4.5 33 33" xmlns="http://www.w3.org/2000/svg">
	<path fill="currentColor" d="m2.726 17.352c0 .184-.149.333-.333.333s-.333-.149-.333-.333.149-.333.333-.333.333.149.333.333z" />
	<path fill="currentColor" d="m1.596 19.413c0 .184-.149.333-.333.333s-.333-.149-.333-.333.149-.333.333-.333.333.149.333.333z" />
	<path fill="currentColor" d="m1.596 17.352c0 .184-.149.333-.333.333s-.333-.149-.333-.333.149-.333.333-.333.333.149.333.333z" />
	<path fill="currentColor" d="m2.726 19.413c0 .184-.149.333-.333.333s-.333-.149-.333-.333.149-.333.333-.333.333.149.333.333z" />
	<path
		fill="currentColor"
